  ...
  useEffect(() => {
    ...
    if (errorParam) {
      ...
      if (errorParam === 'session_error') {
        displayError = `Session error: ${errorMessage || 'Unable to create session'}`
      } else if (errorParam === 'no_code') {
        displayError = 'No authorization code received'
      } else if (errorParam === 'unexpected_error') {
        displayError = 'An unexpected error occurred during authentication'
      } else if (errorDescription) {
        displayError = errorDescription
      } else {
        displayError = `Authentication error: ${errorParam}`
      }
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">RevRank.ai</h1>
            <p className="text-gray-600">Google Business Profile Management Platform</p>
          </div>
        ...
        <div className="mt-4 text-center">
          <a href="/test-supabase" className="text-sm text-gray-600 hover:text-gray-900">
